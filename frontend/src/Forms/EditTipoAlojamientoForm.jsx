        ...
        <section className="section-flex">
            <form onSubmit={actualizarDatos} className="flex-container-center">
                <div className="form-field">
                    ...
                    <input type="text" id='descripcion' name='descripcion' defaultValue={data.Descripcion} onChange={e => setDescripcion(e.target.value)} className="form-input" placeholder=''/>
                </div>
                <div className='form-field'>
